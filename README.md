...
This project uses  to automatically review pull requests and catch bugs, best-practice issues, and improvements.

### How to Integrate 

1. Go to **
2. Install  on your GitHub account
3. Enable it for this repository
4. Open a Pull Request
5. will automatically:
   - Review your code
   - Leave inline comments
   - Highlight bugs, anti-patterns, and improvements

> Code reviews are an essential part of real-world development.
> simulates having a senior developer reviewing your work.
